...
This framework recognizes that Lead HVAC Technician experience can come from various senior-level HVAC roles.
...
- ${requiredYears}+ years as Lead HVAC Technician (direct title match), OR
- ${requiredYears}+ years as Senior HVAC Technician with leadership duties, OR
- ${requiredYears}+ years in equivalent senior HVAC roles (see acceptable titles above) demonstrating 3-4 core competency categories

IMPORTANT NUANCED RULES:
- If flexibility checkbox is CHECKED (flexibleOnTitle = true):
  * Accept ${requiredYears}+ years as HVAC Service Technician (even without "Lead" or "Senior" title) IF they demonstrate leadership competencies
  * Accept ${requiredYears}+ years as HVAC Installer (Lead or Senior level)
  * Accept ${requiredYears}+ years as Maintenance Technician (senior level with HVAC focus)
  * Accept other senior HVAC roles with parallel responsibilities
  * Evaluate based on COMPETENCIES, not strict title matching

- If flexibility checkbox is NOT CHECKED (flexibleOnTitle = false):
  * Candidates who would qualify as "Required" with flexibility ON will drop to "Close to Required" tier
  * Apply -${flexibilityPenalty} point penalty to their final score
  * Still accept direct "Lead HVAC Technician" or "Senior HVAC Technician" titles for Required tier
  * Service Technicians, Installers, Maintenance Techs (without Lead/Senior in title) drop to Close tier
...
- Candidates with strong competencies but slightly less experience
